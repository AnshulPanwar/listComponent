...
class PathResolver {
    ...
    /**
     * Resolves zero or more path portions (relative to the project root)
     * into a single absolute filesystem path.
     *
     * Examples:
     *
     ...
     *   The first argument must be either a path relative to the project root
     *   (e.g., '/test/screenshot'),
     *   or an absolute path to an existing directory
     *   (e.g., '/Users/betty/mdc-web/test/screenshot').
     *   All subsequent arguments are concatenated onto the first argument,
     *   with each part separated by a single
